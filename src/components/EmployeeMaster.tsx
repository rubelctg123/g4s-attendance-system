...
import { Users, Plus, Edit, Trash2, Shield, Search, Check, X, AlertTriangle } from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl border border-slate-200 shadow-xs p-5 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-slate-500">Manage G4S security guards deployed at Vancot Limited factory</p>
        </div>
                ...
                filteredEmployees.map((emp) => (
                  <tr key={emp.id} className="hover:bg-slate-50 transition-colors">
                    ...
                    <td className="px-4 py-3 text-right space-x-1">
                      ...
                      <button
                        onClick={() => onDeleteEmployee(emp.id, emp.employee_id)}
